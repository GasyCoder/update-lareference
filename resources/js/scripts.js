...
// CurrentLink("." + classes.menu.link, classes.menu.item, classes.menu.sub, classes.menu.main, [classes.menu.active, classes.menu.current]);
...
// Show hide pasword
TogglePassword('.js-password-toggle');
//ToggleSection
ToggleBlock();
// Sticky nav 
