            ...
            <div class="m-auto w-full max-w-[420px] xs:max-w-[520px] p-5">
                ...
                <div class="p-5 border border-gray-300 rounded dark:border-gray-900 sm:p-6 md:p-10">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="relative mb-5 last:mb-0">
                            ...
                            <div class="relative">
                                <x-text-input id="username"
                                    ...
                                    type="text" name="username" :value="old('username')" {{-- Correction ici: username au
                                    lieu de username --}} placeholder="Entrez votre identifiant" required autofocus
                        ...
                        <div class="relative mb-5 last:mb-0">
                            <div class="relative">
                                <a tabindex="-1" href="#password"
                                    class="absolute top-0 flex items-center justify-center h-11 w-11 end-0 js-password-toggle group/password">
                                    <em
                                        class="group-[.is-shown]/password:hidden text-slate-400 text-base leading-none ni ni-eye"></em>
                                    <em
                                        class="hidden group-[.is-shown]/password:block text-slate-400 text-base leading-none ni ni-eye-off"></em>
                                </a>
                                <x-text-input id="password"
                                    class="block w-full box-border text-sm leading-4.5 px-4 py-2.5 h-11 text-slate-700 dark:text-white placeholder-slate-300 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 outline-none focus:border-primary-500 focus:dark:border-primary-600 focus:outline-offset-0 focus:outline-primary-200 focus:dark:outline-primary-950 disabled:bg-slate-50 disabled:dark:bg-slate-950 disabled:cursor-not-allowed rounded-md transition-all"
                                    type="password" name="password" placeholder="Entrez votre mot de passe" required
                        ...
                        <div class="relative mb-5 last:mb-0">
                            <x-primary-button
                                class="relative w-full flex items-center justify-center text-center align-middle text-base font-bold leading-4.5 rounded-md px-6 py-3 tracking-wide border border-primary-600 text-white bg-primary-600 hover:bg-primary-700 active:bg-primary-800 transition-all duration-300">
                                {{ __('Se connecter') }}
                            </x-primary-button>
                        </div>
                    </form>
                    ...
                    <div class="flex flex-wrap justify-center -m-2">
                        <div class="w-full p-2">
                            <p class="text-center text-slate-400 text-sm/4">&copy;
                                ...
                                Tous droits réservés. Développé par <a href="https://gasycoder.com"
                                    target="_blank">GasyCoder</a>
                            </p>
                        </div>
                    </div>
                </div>
