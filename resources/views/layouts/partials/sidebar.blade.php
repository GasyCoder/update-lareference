            ...
            <div class="h-full pt-3 pb-8" data-simplebar>
                <ul class="nk-menu">
                    ...
                    @if(auth()->check() && auth()->user()->type === 'secretaire')
                        ...
                        <li
                            class="nk-menu-item py-0.5{{ request()->routeIs('secretaire.prescription.index', 'secretaire.prescription.create', 'secretaire.prescription.edit') ? ' active' : '' }} group/item">
                        ...
                        <li
                            class="nk-menu-item py-0{{ request()->routeIs('secretaire.journal-caisse') ? ' active' : '' }} group/item">
                            <a href="{{ route('secretaire.journal-caisse') }}"
                                ...
                                <span
                                    class="group-[&.is-compact:not(.has-hover)]/sidebar:opacity-0 flex-grow-1 inline-block whitespace-nowrap transition-all duration-300 text-sm text-slate-600 dark:text-slate-500 group-[.active]/item:text-primary-500 group-hover:text-primary-500">Journales</span>
                            </a>
                        </li>

                        <li
                            class="nk-menu-item py-0{{ request()->routeIs('secretaire.etiquettes') ? ' active' : '' }} group/item">
                            <a href="{{ route('secretaire.etiquettes') }}"
                                class="nk-menu-link flex relative items-center align-middle py-2 ps-5 pe-8 font-heading font-bold tracking-snug group">
                                <span
                                    class="font-normal tracking-normal w-8 inline-flex flex-grow-0 flex-shrink-0 text-slate-400 group-[.active]/item:text-primary-500 group-hover:text-primary-500">
                                    <em
                    ...
                    @if(auth()->check() && auth()->user()->type === 'admin')
                        ...
                        <li
                            class="nk-menu-item py-0{{ request()->routeIs('admin.trace-patients') ? ' active' : '' }} group/item">
                            <a href="{{ route('admin.trace-patients') }}"
                                class="nk-menu-link flex relative items-center align-middle py-2 ps-5 pe-8 font-heading font-bold tracking-snug group">
                                <span
                                    class="font-normal tracking-normal w-8 inline-flex flex-grow-0 flex-shrink-0 text-slate-400 group-[.active]/item:text-primary-500 group-hover:text-primary-500">
                                    <em
                    ...
                    <li class="nk-menu-item py-0{{ request()->routeIs('archives') ? ' active' : '' }} group/item">
                        <a href="{{ route('archives') }}"
                            ...
                            <span
                                class="group-[&.is-compact:not(.has-hover)]/sidebar:opacity-0 flex-grow-1 inline-block whitespace-nowrap transition-all duration-300 text-sm text-slate-600 dark:text-slate-500 group-[.active]/item:text-primary-500 group-hover:text-primary-500">
                                Archives (<span
                                    id="archive-count">{{ $countArchive ?? \App\Models\Prescription::where('status', \App\Models\Prescription::STATUS_ARCHIVE)->count() }}</span>)
                            </span>
                        </a>
                    </li>
                    ...
                    @if(auth()->check() && in_array(auth()->user()->type, ['technicien', 'biologiste', 'admin']))
                        ...
                        <!-- Menu Analyses -->
                        <li
                            class="nk-menu-item py-0 has-sub group/item{{ request()->routeIs('laboratoire.analyses.*') ? ' active' : '' }}">
                            <a href="#"
                            ...
                            <ul class="nk-menu-sub mb-1 hidden group-[&.is-compact:not(.has-hover)]/sidebar:!hidden" {{ request()->routeIs('laboratoire.analyses.*') ? ' style=display:block' : '' }}>
                                <li
                                    class="nk-menu-item py-px sub has-sub group/sub1{{ request()->routeIs('laboratoire.analyses.examens') ? ' active' : '' }}">
                                    <a href="{{ route('laboratoire.analyses.examens') }}"
                                ...
                                <li
                                    class="nk-menu-item py-px sub has-sub group/sub1{{ request()->routeIs('laboratoire.analyses.types') ? ' active' : '' }}">
                                    <a href="{{ route('laboratoire.analyses.types') }}"
                                        class="nk-menu-link flex relative items-center align-middle py-1 pe-8 ps-[calc(theme(spacing.5)+theme(spacing.8))] font-normal leading-5 text-xs tracking-normal normal-case">
                                        <span
                                ...
                                <li
                                    class="nk-menu-item py-px sub has-sub group/sub1{{ request()->routeIs('laboratoire.analyses.listes') ? ' active' : '' }}">
                                    <a href="{{ route('laboratoire.analyses.listes') }}"
                                        class="nk-menu-link flex relative items-center align-middle py-1 pe-8 ps-[calc(theme(spacing.5)+theme(spacing.8))] font-normal leading-5 text-xs tracking-normal normal-case">
                                        <span
                                ...
                                <li
                                    class="nk-menu-item py-px sub has-sub group/sub1{{ request()->routeIs('laboratoire.analyses.prelevements') ? ' active' : '' }}">
                                    <a href="{{ route('laboratoire.analyses.prelevements') }}"
                                        class="nk-menu-link flex relative items-center align-middle py-1 pe-8 ps-[calc(theme(spacing.5)+theme(spacing.8))] font-normal leading-5 text-xs tracking-normal normal-case">
                                        <span
                        ...
                        <!-- Menu Microbiologie -->
                        <li
                            class="nk-menu-item py-0 has-sub group/item{{ request()->routeIs('laboratoire.microbiologie.*') ? ' active' : '' }}">
                            <a href="#"
                                class="nk-menu-link sub nk-menu-toggle flex relative items-center align-middle py-2 ps-5 pe-8 font-heading font-bold tracking-snug group">
                                <span
                                    class="font-normal tracking-normal w-8 inline-flex flex-grow-0 flex-shrink-0 text-slate-400 group-[.active]/item:text-primary-500 group-hover:text-primary-500">
                            ...
                            <ul class="nk-menu-sub mb-1 hidden group-[&.is-compact:not(.has-hover)]/sidebar:!hidden" {{ request()->routeIs('laboratoire.microbiologie.*') ? ' style=display:block' : '' }}>
                                <li
                                    class="nk-menu-item py-px sub has-sub group/sub1{{ request()->routeIs('laboratoire.microbiologie.familles-bacteries') ? ' active' : '' }}">
                                    <a href="{{ route('laboratoire.microbiologie.familles-bacteries') }}"
                                        class="nk-menu-link flex relative items-center align-middle py-1 pe-8 ps-[calc(theme(spacing.5)+theme(spacing.8))] font-normal leading-5 text-xs tracking-normal normal-case">
                                        <span
                                ...
                                <li
                                    class="nk-menu-item py-px sub has-sub group/sub1{{ request()->routeIs('laboratoire.microbiologie.bacteries') ? ' active' : '' }}">
                                    <a href="{{ route('laboratoire.microbiologie.bacteries') }}"
                                        class="nk-menu-link flex relative items-center align-middle py-1 pe-8 ps-[calc(theme(spacing.5)+theme(spacing.8))] font-normal leading-5 text-xs tracking-normal normal-case">
                                        <span
                                ...
                                <li
                                    class="nk-menu-item py-px sub has-sub group/sub1{{ request()->routeIs('laboratoire.microbiologie.antibiotiques') ? ' active' : '' }}">
                                    <a href="{{ route('laboratoire.microbiologie.antibiotiques') }}"
                                        class="nk-menu-link flex relative items-center align-middle py-1 pe-8 ps-[calc(theme(spacing.5)+theme(spacing.8))] font-normal leading-5 text-xs tracking-normal normal-case">
                                        <span
