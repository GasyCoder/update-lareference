    ...
    <div class="py-6">
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-3">
                        <button wire:click="resetForm"
                            class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest focus:outline-none focus:border-gray-700 focus:shadow-outline-gray active:bg-gray-600 transition ease-in-out duration-150">
            ...
            @if (session()->has('success'))
                <div
                    class="mb-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 text-green-700 dark:text-green-300 px-4 py-3 rounded-lg">
                    <div class="flex">
            ...
            @if (session()->has('error'))
                <div
                    class="mb-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 text-red-700 dark:text-red-300 px-4 py-3 rounded-lg">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            ...
                            <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                                ...
                                <div class="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div class="bg-white dark:bg-gray-800 p-3 rounded border">
                                        ...
                                        <div class="text-lg font-semibold">{{ $impactChangement['paiementsAfectes'] ?? 0 }}
                                        </div>
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 p-3 rounded border">
                                        <div class="text-xs text-gray-500 dark:text-gray-400">Ancien total</div>
                                        <div class="text-lg font-semibold">
                                            {{ number_format($impactChangement['ancienTotal'] ?? 0, 0, ',', ' ') }} Ar</div>
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 p-3 rounded border">
                                        <div class="text-xs text-gray-500 dark:text-gray-400">Différence</div>
                                        <div
                                            class="text-lg font-semibold {{ ($impactChangement['difference'] ?? 0) >= 0 ? 'text-red-600' : 'text-green-600' }}">
                                            {{ ($impactChangement['difference'] ?? 0) >= 0 ? '+' : '' }}{{ number_format($impactChangement['difference'] ?? 0, 0, ',', ' ') }}
                                            Ar
                                        </div>
                                    </div>
                                </div>
                                <p class="mt-2 text-xs">
                                    🤖 <strong>Le recalcul sera automatique</strong> après sauvegarde - toutes les
                                    commissions existantes seront mises à jour.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <!-- Aide -->
                    <div
                        class="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 shadow-lg rounded-lg overflow-hidden border border-blue-200 dark:border-blue-700">
                        <div class="px-6 py-4">
                        ...
                        <div class="px-6 pb-6">
                            <div class="text-sm text-blue-800 dark:text-blue-300 space-y-2">
                                ...
                                <p class="text-xs">Les commissions sont recalculées automatiquement lors du changement
                                    de pourcentage.</p>

                                <p class="pt-2"><strong>🧪 Biologie Solidaire :</strong></p>
                                <p class="text-xs">Les prescripteurs "Biologie Solidaire" ne perçoivent jamais de
                                    commission (toujours 0%).</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-4 space-y-6">
                        ...
                        <form wire:submit.prevent="sauvegarderRemises">
                            <div class="p-6 space-y-6">
                                <div
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" wire:model="activer_remise" id="activer_remise"
                                            class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                        <label for="activer_remise"
                                ...
                                @if($activer_remise)
                                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input type="number" wire:model="remise_pourcentage" step="0.01" min="0"
                                                    max="100"
                                                    class="w-full px-3 py-2 pr-12 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-primary-500 dark:focus:border-primary-400 text-gray-900 dark:text-white">
                                                <div
                            ...
                            <div
                                ...
                                <button type="submit" wire:loading.attr="disabled"
                                    ...
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                        wire:loading.remove wire:target="sauvegarderRemises">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z">
                                        </path>
                                    </svg>
                                    <svg class="animate-spin w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" wire:loading
                                        wire:target="sauvegarderRemises">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                        <div
                            class="px-6 py-4 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border-b border-yellow-200 dark:border-yellow-700">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white flex items-center">
                        ...
                        <form wire:submit.prevent="sauvegarderCommissions">
                            <div class="p-6 space-y-6">
                                <div
                                    class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                    <div class="flex items-center">
                                        <input type="checkbox" wire:model="commission_prescripteur"
                                            id="commission_prescripteur"
                                            class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                        <label for="commission_prescripteur"
                                            class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6">
                                            <div>
                                                ...
                                                <div class="relative">
                                                    <input type="number"
                                                        wire:model.live="commission_prescripteur_pourcentage" step="0.01"
                                                        min="0" max="100"
                                                        class="w-full px-3 py-2 pr-12 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-primary-500 dark:focus:border-primary-400 text-gray-900 dark:text-white">
                                                    <div
                                                        class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                            ...
                                            <div
                                                class="flex items-center justify-center p-4 bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-lg border border-primary-200 dark:border-primary-700">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                <label
                                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                    Quota mensuel par défaut (Ar) *
                                                </label>
                                                <div class="relative">
                                                    <input type="number" wire:model="commission_prescripteur_quota"
                                                        step="1000" min="0"
                                                        class="w-full px-3 py-2 pr-12 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-primary-500 dark:focus:border-primary-400 text-gray-900 dark:text-white">
                                                    <div
                                                        class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                ...
                                                @error('commission_prescripteur_quota')
                                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            <div
                                                class="flex items-center justify-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg border border-green-200 dark:border-green-700">
                                                <div class="text-center">
                                                    <div class="text-xl font-bold text-green-600 dark:text-green-400">
                                                        {{ number_format($commission_prescripteur_quota, 0, ',', ' ') }} Ar
                                                    </div>
                                                    <div class="text-xs text-green-500 dark:text-green-300 mt-1">
                                                        Quota global par défaut
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div
                                class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700 flex justify-end">
                                <button type="submit" wire:loading.attr="disabled"
                                    class="inline-flex items-center px-4 py-2 bg-yellow-600 hover:bg-yellow-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest focus:outline-none focus:border-yellow-700 focus:shadow-outline-yellow active:bg-yellow-600 transition ease-in-out duration-150 disabled:opacity-50">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                        wire:loading.remove wire:target="sauvegarderCommissions">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <svg class="animate-spin w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" wire:loading
                                        wire:target="sauvegarderCommissions">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                            stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor"
                                            d="m4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">
                    ...
                    <!-- Statistiques -->
                    <div
                        class="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 shadow-lg rounded-lg overflow-hidden border border-indigo-200 dark:border-indigo-700">
                        <div class="px-6 py-4">
