...
<div>
    ...
    <div class="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
                <h1 class="text-3xl font-heading font-bold text-gray-900 dark:text-white">Archives des Prescriptions
                </h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Consultez et gérez les prescriptions archivées du
                    laboratoire</p>
            </div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 max-w-md lg:max-w-none">
                <div
                    class="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 px-3 py-2 rounded-xl border border-purple-200 dark:border-purple-700">
                    <div class="text-xs font-medium text-purple-600 dark:text-purple-400 uppercase tracking-wide">Total
                        Archivées</div>
                    <div class="text-xl font-bold text-purple-800 dark:text-purple-300">
                        {{ $prescriptions->total() ?? 0 }}</div>
                </div>
                <div
                    class="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 px-3 py-2 rounded-xl border border-blue-200 dark:border-blue-700">
                    <div class="text-xs font-medium text-blue-600 dark:text-blue-400 uppercase tracking-wide">Ce Mois
                    </div>
                    <div class="text-xl font-bold text-blue-800 dark:text-blue-300">{{ $archivesMoisActuel ?? 0 }}</div>
                </div>
                <div
                    class="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 px-3 py-2 rounded-xl border border-green-200 dark:border-green-700">
                    <div class="text-xs font-medium text-green-600 dark:text-green-400 uppercase tracking-wide">Analyses
                    </div>
                    <div class="text-xl font-bold text-green-800 dark:text-green-300">{{ $totalAnalyses ?? 0 }}</div>
                </div>
                <div
                    class="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 px-3 py-2 rounded-xl border border-orange-200 dark:border-orange-700">
                    <div class="text-xs font-medium text-orange-600 dark:text-orange-400 uppercase tracking-wide">
                        Patients</div>
                    <div class="text-xl font-bold text-orange-800 dark:text-orange-300">{{ $patientsUniques ?? 0 }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div class="lg:col-span-2">
                    <label for="search"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Rechercher</label>
                    <div class="relative">
                ...
                <div>
                    <label for="prescripteurFilter"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Prescripteur</label>
                    <select wire:model.live="prescripteurFilter" id="prescripteurFilter"
                ...
                <div>
                    <label for="dateFilter"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Période</label>
                            ...
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="flex-shrink-0 w-10 h-10">
                                            <div
                                                class="w-10 h-10 rounded-full bg-gradient-to-br from-green-400 to-green-600 dark:from-green-500 dark:to-green-700 flex items-center justify-center shadow-lg">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="flex-shrink-0 w-10 h-10">
                                            <div
                                                class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 dark:from-blue-500 dark:to-blue-700 flex items-center justify-center shadow-lg">
                                                <span class="text-white font-bold text-sm">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center px-3 py-1.5 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 text-sm font-semibold rounded-lg">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Aucune prescription
                                            archivée trouvée</h3>
                                        <p class="text-sm text-gray-500 dark:text-gray-400 max-w-sm">
                                            @if($search || $prescripteurFilter || $dateFilter)
                                                Essayez de modifier vos critères de recherche pour voir plus de résultats.
                                            @else
                                                Les prescriptions archivées apparaîtront ici une fois que des prescriptions
                                                auront été archivées.
                                            @endif
                                        </p>
                                    </div>
                                </td>
            ...
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity z-[9999]" wire:click="resetModal">
                <div class="fixed inset-0 z-[9999] w-screen">
                    <div class="flex min-h-full items-center justify-center p-4"
                        style="margin-top: 4rem; padding-top: 2rem; padding-bottom: 4rem;">
                        <div class="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 text-left shadow-xl transition-all w-full max-w-md"
                            ...
                            <div class="bg-white dark:bg-gray-800 px-6 py-6">
                                <div
                                    class="flex items-center justify-center w-12 h-12 mx-auto bg-amber-100 dark:bg-amber-900/30 rounded-full mb-4">
                            ...
                            <div
                                class="bg-gray-50 dark:bg-gray-700/50 px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
                        ...
                        <div class="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 text-left shadow-xl transition-all w-full max-w-md"
                            ...
                            <div class="bg-white dark:bg-gray-800 px-6 py-6">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">
                                        Cette action est irréversible. La prescription sera définitivement supprimée de la
                                        base de données.
                                    </p>
                                </div>
                            </div>
