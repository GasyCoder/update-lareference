<div>
    ...
    <div class="py-6">
        <div class="mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div
                                class="bg-cyan-50 dark:bg-cyan-900/20 rounded-lg p-4 border border-cyan-200 dark:border-cyan-800">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-cyan-900 dark:text-cyan-100">
                                            {{ $stats['patients']['total'] ?? 0 }}</p>
                                    </div>
                                    <div
                                        class="w-8 h-8 bg-cyan-100 dark:bg-cyan-800 rounded-full flex items-center justify-center">
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-yellow-900 dark:text-cyan-100">
                                            {{ $stats['patients']['fideles'] ?? 0 }}</p>
                                    </div>
                                    <div
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-red-900 dark:text-cyan-100">
                                            {{ $stats['patients']['vip'] ?? 0 }}</p>
                                    </div>
                                    <div
                                        ...
                                        <svg class="w-4 h-4 text-red-600 dark:text-red-400" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path
                                                d="M9.663 17h4.673a1.305 1.305 0 001.305-1.305v-5.39a3.26 3.26 0 00-3.26-3.26H9.663a3.26 3.26 0 00-3.26 3.26v5.39A1.305 1.305 0 009.663 17z" />
                                            <path
                                                d="M5.5 7c.828 0 1.5-.895 1.5-2s-.672-2-1.5-2S4 3.895 4 5s.672 2 1.5 2zm9 0c.828 0 1.5-.895 1.5-2s-.672-2-1.5-2S13 3.895 13 5s.672 2 1.5 2z" />
                                        </svg>
                                    </div>
                                </div>
                            </div>
            ...
            @if($user->hasAnyPermission(['analyses.view', 'analyses.perform', 'analyses.validate']))
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div
                                class="bg-slate-50 dark:bg-slate-900/20 rounded-lg p-4 border border-slate-200 dark:border-slate-700">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-slate-700 dark:text-slate-300">En attente</p>
                                        <p class="text-2xl font-bold text-slate-900 dark:text-slate-100">
                                            {{ $stats['analyses']['en_attente'] ?? 0 }}</p>
                                    </div>
                                    <div
                                        class="w-8 h-8 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center">
                                        <svg class="w-4 h-4 text-slate-600 dark:text-slate-400" fill="currentColor"
                                            viewBox="0 0 20 20">
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-orange-900 dark:text-orange-100">
                                            {{ $stats['analyses']['terminees'] ?? 0 }}</p>
                                    </div>
                                    <div
                                        class="w-8 h-8 bg-orange-100 dark:bg-orange-800 rounded-full flex items-center justify-center">
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Résultats
                                        pathologiques</span>
                                </div>
                                <span
                                    class="text-lg font-bold text-red-600 dark:text-red-400">{{ $stats['analyses']['pathologiques'] ?? 0 }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-green-700 dark:text-green-300">Recettes du jour
                                        </p>
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-purple-700 dark:text-purple-300">Nombre paiements
                                        </p>
                                        <p class="text-xl font-bold text-purple-900 dark:text-purple-100">
                                            {{ $stats['finances']['nb_paiements'] ?? 0 }}</p>
                                    </div>
                                    <div
                    ...
                    <div class="space-y-3">
                        @forelse($stats['activites'] ?? [] as $activite)
                            <div class="flex items-start space-x-3">
                                <div
                                    class="w-2 h-2 bg-{{ $activite['color'] ?? 'gray' }}-400 rounded-full mt-2 flex-shrink-0">
                                </div>
                        ...
                        @empty
                            <div class="text-center py-8">
                                <div
                                    class="w-12 h-12 mx-auto bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        @if($user->hasPermission('prescriptions.view'))
                            <a href="{{ route('secretaire.patients') }}"
                                class="group bg-primary-50 hover:bg-primary-100 dark:bg-primary-900/20 dark:hover:bg-primary-900/30 rounded-lg p-4 border border-primary-200 dark:border-primary-800 transition-colors">
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-primary-100 dark:bg-primary-800 rounded-lg flex items-center justify-center group-hover:bg-primary-200 dark:group-hover:bg-primary-700 transition-colors">
                        ...
                        @if($user->hasPermission('prescriptions.view'))
                            <a href="{{ route('secretaire.prescription.index') }}"
                                class="group bg-cyan-50 hover:bg-cyan-100 dark:bg-cyan-900/20 dark:hover:bg-cyan-900/30 rounded-lg p-4 border border-cyan-200 dark:border-cyan-800 transition-colors">
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-cyan-100 dark:bg-cyan-800 rounded-lg flex items-center justify-center group-hover:bg-cyan-200 dark:group-hover:bg-cyan-700 transition-colors">
                                        <svg class="w-5 h-5 text-cyan-600 dark:text-cyan-400" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                                            <path fill-rule="evenodd"
                                                d="M4 5a2 2 0 012-2v1a2 2 0 002 2h4a2 2 0 002-2V3a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm8 8a1 1 0 100-2 1 1 0 000 2z"
                                                clip-rule="evenodd" />
                                        </svg>
                                    </div>
                        ...
                        @if($user->hasPermission('analyses.validate'))
                            <a href="{{ route('biologiste.analyse.index') }}"
                                class="group bg-green-50 hover:bg-green-100 dark:bg-green-900/20 dark:hover:bg-green-900/30 rounded-lg p-4 border border-green-200 dark:border-green-800 transition-colors">
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-green-100 dark:bg-green-800 rounded-lg flex items-center justify-center group-hover:bg-green-200 dark:group-hover:bg-primary-700 transition-colors">
                        ...
                        @if($user->hasPermission('analyses.perform'))
                            <a href="{{ route('technicien.index') }}"
                                class="group bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/20 dark:hover:bg-blue-900/30 rounded-lg p-4 border border-blue-200 dark:border-blue-800 transition-colors">
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-blue-100 dark:bg-blue-800 rounded-lg flex items-center justify-center group-hover:bg-blue-200 dark:group-hover:bg-primary-700 transition-colors">
