                ...
                <div
                    ...
                    <div class="bg-white dark:bg-gray-800 px-6 py-6">
                        <div class="flex items-center mb-4">
                            <div
                                class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-red-900/30">
                        ...
                        <div class="text-center">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Déplacer vers la corbeille
                            </h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                                Êtes-vous sûr de vouloir déplacer <strong>{{ $prescripteurToDelete?->nom_complet }}</strong>
                                vers la corbeille ?
                                ...
                                @endif
                                <br><span class="text-gray-600 dark:text-gray-400 text-xs mt-2 block">
                    ...
                    <div
                        ...
                        <button wire:click="deletePrescripteur"
