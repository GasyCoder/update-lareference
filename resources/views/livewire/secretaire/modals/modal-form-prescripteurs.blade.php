                        ...
                        <form wire:submit="savePrescripteur">
                            <div class="bg-white dark:bg-gray-800 px-6 py-6">
                                <div class="flex items-center justify-between mb-6">
                                    ...
                                    <button type="button" wire:click="closePrescripteurModal"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <!-- {{-- w<div>
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <label class="inline-flex items-center mr-6">
                                                <input type="radio" wire:model="grade" value="{{ $value }}"
                                                ...
                                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">{{ $label
                                                    }}</span>
                                            </label>
                                            @endforeach
                                            <label class="inline-flex items-center mr-6">
                                                <input type="radio" wire:model="grade" value=""
                                                    class="form-radio h-4 w-4 text-primary-600 border-gray-300 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:focus:ring-primary-400">
                                    ...
                                    <div>
                                        <label for="specialite"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Spécialité</label>
                                        <input type="text" wire:model="specialite" id="specialite"
                                    ...
                                    <!-- Commission Quota -->
                                    <div>
                                        <label for="commission_quota"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            Quota mensuel de commission (Ar) <span class="text-red-500">*</span>
                                        </label>
                                        <input type="number" wire:model="commission_quota" id="commission_quota" step="0.01"
                                            class="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-primary-500 dark:focus:border-primary-400 @error('commission_quota') border-red-500 @enderror">
                                        @error('commission_quota')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        <label for="commission_pourcentage"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            Pourcentage de commission (%) <span class="text-red-500">*</span>
                                        </label>
                                        <input type="number" wire:model="commission_pourcentage" id="commission_pourcentage"
                                            step="0.01"
                                            class="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-primary-500 dark:focus:border-primary-400 @error('commission_pourcentage') border-red-500 @enderror">
                                        @error('commission_pourcentage')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea wire:model="adresse" id="adresse" rows="2"
                                            class="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-primary-500 dark:focus:border-primary-400 @error('adresse') border-red-500 @enderror"></textarea>
                                        @error('adresse')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        <label for="code_postal"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Code
                                            postal</label>
                                        <input type="text" wire:model="code_postal" id="code_postal"
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea wire:model="notes" id="notes" rows="3"
                                            class="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-primary-500 dark:focus:border-primary-400 @error('notes') border-red-500 @enderror"></textarea>
                                        @error('notes')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
