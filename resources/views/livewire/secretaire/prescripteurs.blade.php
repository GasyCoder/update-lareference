                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        @else
                                            <div class="flex flex-col">
                                                ...
                                                @php
                                                    $bruteMensuel = $prescripteur->getBruteAnalysesMensuel();
                                                    $quotaAtteint = $bruteMensuel >= $prescripteur->commission_quota;
                                                @endphp
                                                @if(!$quotaAtteint)
                                                    <div class="mt-1 text-[10px] text-orange-500 font-medium whitespace-nowrap" title="Quota: {{ number_format($prescripteur->commission_quota, 0, ',', ' ') }} Ar">
                                                        Quota: {{ number_format($bruteMensuel, 0, ',', ' ') }} / {{ number_format($prescripteur->commission_quota, 0, ',', ' ') }}
                                                    </div>
                                                @else
                                                    <div class="mt-1 text-[10px] text-green-500 font-medium whitespace-nowrap">
                                                        Quota atteint ({{ number_format($bruteMensuel, 0, ',', ' ') }} Ar)
                                                    </div>
                                                @endif
                                            </div>
                                        @endif
