    ...
    <div class="px-4 py-6 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                @endphp
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $analysesTerminees }}/{{ $totalAnalyses }}
                    terminées</p>
            </div>
        </div>
    </div>
        ...
        <div class="p-3 space-y-2">
            @forelse($analysesParents as $parent)
                    <div class="relative group">
                        ...
                        <button type="button" wire:key="parent-{{ $parent['id'] }}"
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-shrink-0 pt-1">
                                    @if($parent['status'] === 'TERMINE')
                                        <div
                                            class="w-6 h-6 bg-green-600 dark:bg-green-700 rounded-md flex items-center justify-center">
                                    ...
                                    @elseif($parent['status'] === 'EN_COURS')
                                        <div
                                            class="w-6 h-6 bg-orange-500 dark:bg-orange-600 rounded-md flex items-center justify-center">
                                            <em class="text-xl ni ni-loader"></em>
                                        </div>
                                    @else
                                        {{-- VIDE state --}}
                                        <div
                                            class="w-6 h-6 bg-gray-400 dark:bg-gray-600 rounded-md flex items-center justify-center">
            ...
            @if(count($analysesParents) > 0 && (auth()->user()->hasAnyPermission(['analyses.perform', 'analyses.validate', 'analyses.view'])))
                <div class="pt-4 border-t border-gray-200 dark:border-gray-700 mt-4">
                    ...
                    @elseif($this->isReadyToFinalize())
                        ...
                        <button wire:click="markPrescriptionAsCompleted" wire:loading.attr="disabled"
                            ...
                            <span wire:loading wire:target="markPrescriptionAsCompleted"
