    ...
    <div class="max-w-12xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                {{-- Indicateur système --}}
                <div
                    class="flex items-center gap-2 px-3 py-1.5 bg-green-50 dark:bg-green-900/30 rounded-full border border-green-200 dark:border-green-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div
                class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white shadow-lg flex flex-col justify-between h-20">
            ...
            <!-- TERMINÉ -->
            <div
                class="bg-gradient-to-r from-teal-500 to-teal-600 rounded-lg p-6 text-white shadow-lg flex flex-col justify-between h-20">
                <div class="flex items-center justify-between h-full">
                    <div class="flex flex-col justify-between h-full">
            ...
            <!-- À REFAIRE -->
            <div
                class="bg-gradient-to-r from-red-500 to-red-600 rounded-lg p-6 text-white shadow-lg flex flex-col justify-between h-20">
                <div class="flex items-center justify-between h-full">
                    <div class="flex flex-col justify-between h-full">
                ...
                <nav class="-mb-px flex">
                    <button wire:click="$set('activeTab', 'en_attente')"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            Toutes
                            <span
                                class="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">{{ $stats['toutes'] ?? 0 }}</span>
                        </div>
                    </button>
                    ...
                    <button wire:click="$set('activeTab', 'termine')"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            Terminé
                            <span
                                class="bg-teal-100 text-teal-800 text-xs px-2 py-1 rounded-full">{{ $stats['termine'] ?? 0 }}</span>
                        </div>
                    </button>
                    ...
                    <button wire:click="$set('activeTab', 'a_refaire')"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            À refaire
                            <span
                                class="bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full">{{ $stats['a_refaire'] ?? 0 }}</span>
                        </div>
                    </button>
                </nav>
            </div>
                ...
                @if($activeTab === 'en_attente')
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-blue-50 dark:bg-blue-900/20">
                            <tr>
                                <th
                                    class="px-6 py-3 text-left text-xs font-medium text-blue-700 dark:text-blue-300 uppercase tracking-wider">
                                    Référence</th>
                                <th
                                    class="px-6 py-3 text-left text-xs font-medium text-blue-700 dark:text-blue-300 uppercase tracking-wider">
                                    Patient</th>
                                ...
                                <tr class="hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div
                                                class="w-8 h-8 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center text-orange-600 dark:text-orange-300 font-medium text-sm mr-3">
                ...
                @elseif($activeTab === 'termine')
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-teal-50 dark:bg-teal-900/20">
                            <tr>
                                <th
                                    class="px-6 py-3 text-left text-xs font-medium text-teal-700 dark:text-teal-300 uppercase tracking-wider">
                                    Référence</th>
                                <th
                                    class="px-6 py-3 text-left text-xs font-medium text-teal-700 dark:text-teal-300 uppercase tracking-wider">
                                    Patient</th>
                            ...
                            @forelse($prescriptionsTerminees as $prescription)
                                <tr class="hover:bg-teal-50 dark:hover:bg-teal-900/10 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div
                                                class="w-8 h-8 bg-teal-100 dark:bg-teal-900 rounded-full flex items-center justify-center text-teal-600 dark:text-teal-300 font-medium text-sm mr-3">
                            ...
                            @forelse($prescriptionsARefaire as $prescription)
                                <tr class="hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div
                                                class="w-8 h-8 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center text-red-600 dark:text-red-300 font-medium text-sm mr-3">
                                                {{ substr($prescription->patient->prenom, 0, 1) }}{{ substr($prescription->patient->nom, 0, 1) }}
                                            </div>
                                            <div>
                                                <div class="text-sm font-medium text-gray-900 dark:text-white">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if(auth()->user()->hasAnyPermission(['analyses.perform', 'analyses.validate']))
